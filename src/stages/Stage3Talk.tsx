...
const SCENARIO_FALLBACK: SceneItem[] = [
  ...
  { scene: 'スポーツについて話す', charLine: 'Do you like sports?',              charLineJa: '（スポーツは好きですか？）',               answer: 'Yes, I do. I like soccer.',     acceptWords: ['yes i do','no i do not','i like','soccer','baseball','tennis','basketball'], hint: '「Yes, I do. I like soccer.」と言ってみよう' },
  ...
  { scene: 'ペットの話',      charLine: 'Do you have any pets?',                  charLineJa: '（ペットはいますか？）',                   answer: 'Yes, I have a cat.',            acceptWords: ['cat','dog','rabbit','have','yes'],                                        hint: '「Yes, I have a [動物].」と言ってみよう' },
  ...
  { scene: '音楽の話',        charLine: 'Do you like music?',                    charLineJa: '（音楽は好きですか？）',                   answer: 'Yes, I like music very much.',  acceptWords: ['like','music','yes','much','love'],                                       hint: '「Yes, I like music very much.」と言ってみよう' },
  ...
  { scene: '野菜の好み',      charLine: 'Do you like vegetables?',               charLineJa: '（野菜は好きですか？）',                   answer: 'Yes, I love vegetables.',       acceptWords: ['vegetables','love','yes','like'],                                         hint: '「Yes, I love vegetables.」と言ってみよう' },
